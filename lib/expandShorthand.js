...
import SimpleSchemaCustomType from './SimpleSchemaCustomType';
...
function expandShorthand(schema) {
  ...
  _.each(schema, (definition, key) => {
    ...
    // CASE 4: The definition is a custom type
    if (definition instanceof SimpleSchemaCustomType) {
      definition.build(key, schemaClone, schema);
      return;
    }

    // CASE 5: The definition is something, a type
